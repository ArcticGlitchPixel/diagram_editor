...
const AnnotationColorPicker: React.FC<AnnotationColorPickerProps> = ({
  ...
  const presetColors = [
    { value: '#ec6f6f', name: t.red || 'Red' },
    { value: '#f99157', name: t.orange || 'Orange' },
    { value: '#f9c74f', name: t.yellow || 'Yellow' },
    { value: '#22C55E', name: t.green || 'Green' },
    { value: '#5c9ee6', name: t.blue || 'Blue' },
    { value: '#b56fbe', name: t.purple || 'Purple' },
    { value: '#f8c1b0', name: t.pink || 'Pink' },
    { value: '#c2c2c2', name: t.gray || 'Gray' },
  ];
      ...
      >
        <div className="flex items-center gap-2 mb-3">
          ...
          <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-200">
            {t.changeNodeColor || 'Change color'}
          </h3>
        </div>
